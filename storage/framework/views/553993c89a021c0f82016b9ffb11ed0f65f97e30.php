                                                            ...
                                                            <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                  ...
                                                                  <?php endif; ?>
                                                                    ...
                                                                    <td>
                                                                      <a href="<?php echo e(route('sale.sale-detail', ['id'=>$sale->id])); ?>" class="btn btn-primary" title="View Sale" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                      <a href="<?php echo e(route('sale.sale-edit', ['id'=>$sale->id])); ?>" class="btn btn-primary" title="Edit Sale" style="color: #fff;"><i class="fa fa-pencil"></i></a>
                                                                      <a href="<?php echo e(route('sale.sale-delete', ['id'=>$sale->id])); ?>" class="btn btn-primary" title="Delete Sale" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                      <a href="<?php echo e(route('sales-list-print-english', ['id' => $sale->id])); ?>" class="btn btn-primary btn-print" title="Print Sale" style="color: #fff;"><i class="fa fa-print"></i></a>
                                                                    </td>
                                                                </tr>
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/sales/sales-list.blade.php ENDPATH**/ ?>