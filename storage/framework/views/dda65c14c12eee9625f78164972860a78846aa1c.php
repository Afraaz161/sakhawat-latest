...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Purchase Accounts</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="" class="btn btn-primary btn-add-purchase-payment" data-id="<?php echo e($vendor->id); ?>" style="color: #fff;"><i class="fa fa-plus"></i></a>
                                                                      <a href="<?php echo e(route('vendor.view-payment-detail', ['id' => $vendor->id])); ?>" class="btn btn-primary" data-id="<?php echo e($vendor->id); ?>" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
    ...
    <div class="modal fade" id="add-purchase-payment-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog ms-modal-dialog-width">
          <div class="modal-content ms-modal-content-width">
            <div class="modal-header  ms-modal-header-radius-0">
              <h4 class="modal-title text-white">Add Payment to Purchase</h4>
              <button type="button" class="close  text-white" data-dismiss="modal" aria-hidden="true">x</button>
            </div>
            <div class="modal-body p-0 text-left" id="show-add-purchase-payment-modal">
    ...
    <script>
        $(document).ready(function(){
            $('.btn-add-purchase-payment').click(function(e){
                e.preventDefault();
                var id = $(this).attr('data-id');
                $.ajax({
                  type: "GET",
                  url: "<?php echo e(route('get-purchase-payment-detail')); ?>",
                  data: {id:id},
                  success: function(data){
                     document.querySelector("#show-add-purchase-payment-modal").innerHTML = (data);
                     $('#add-purchase-payment-modal').modal('show');
                  },
                  error: function(data){
                     alert('Error...!');
                  }
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/payment/purchase-payment.blade.php ENDPATH**/ ?>