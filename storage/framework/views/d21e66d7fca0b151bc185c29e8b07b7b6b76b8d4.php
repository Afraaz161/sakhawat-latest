                                ...
                                <div class="sparkline7-list">
                                    ...
                                    <div class="sparkline7-graph">
                                        ...
                                        <div class="row" style="text-align: left;">
                                          <form action="<?php echo e(route('purchase.search-purchase')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="col-lg-3">
                                        ...
                                        <div class="row" style="text-align: left;">
                                          <form action="<?php echo e(route('purchase.search-purchase-by-lot')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="col-lg-3">
                                              <div class="form-group">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="<?php echo e(route('purchase.purchase-detail', ['id'=>$purchase->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                      <a href="<?php echo e(route('purchase.purchase-delete', ['id'=>$purchase->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                      
                                                                      <a href="<?php echo e(route('purchase-list-print-english', ['id' => $purchase->id])); ?>" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i></a>
                                                                    </td>
                                                                </tr>
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/purchase/purchase-list.blade.php ENDPATH**/ ?>