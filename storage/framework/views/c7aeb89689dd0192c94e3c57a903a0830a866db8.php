                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td><?php echo e($item->ntn_no); ?></td>
                                              <td>
                                                <a href="<?php echo e(route('account.edit-account', ['id'=>$item->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo e(route('account.delete-account', ['id'=>$item->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                              </td>
                                          </tr>
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/accounts/account-list.blade.php ENDPATH**/ ?>