                            ...
                            <div class="transition-world-list shadow-reset">
                                <div class="sparkline7-list">
                                    ...
                                    <div class="sparkline7-graph">
                                              ...
                                              <div class="col-lg-2" id="name-section">
                                                <div class="form-group">
                                                  ...
                                                  <select name="name" id="name" class="form-control">
                                                    ...
                                                    <?php $__currentLoopData = $total_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                                </div>
                                              </div>
                                              <div class="col-lg-2" id="urdu-name-section">
                                                <div class="form-group">
                                                  <label for="email">نام</label>
                                                  <select name="u_name" id="u_name" class="form-control">
                                                    <option value="">Choose Urdu Name</option>
                                                    <?php $__currentLoopData = $total_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      <option value="<?php echo e($item->id); ?>"><?php echo e($item->u_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                                </div>
                                              </div>
                                        ...
                                        <div class="row">
                                            <a href="#" class="btn btn-primary" id="view-total-stock-value" style="float: right;margin-bottom:10px;">View Total Value</a>
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
                                                    ...
                                                    <div class="col-lg-12" id="total-rorder-stock-value" style="margin-top: 25px;margin-bottom: 25px;">
                                                      <h3><b>Total Reorder Stock Value:<?php echo e($sum); ?></b></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/stock/search-reorder-items.blade.php ENDPATH**/ ?>