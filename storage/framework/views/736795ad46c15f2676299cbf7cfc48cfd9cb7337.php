                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Receivables Detail</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            ...
                                            <div class="sparkline7-outline-icon">
                                                <span><a href="<?php echo e(route('print-customer-ledger', ['id'=> $id])); ?>" class="btn-print"><i class="fa fa-print"></i></a></span>
                                                <span><a href="<?php echo e(route('email-customer-ledger', ['id'=> $id])); ?>"><i class="fa fa-envelope"></i></a></span>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($payment->received); ?></td>
                                                                <td class="text-success"><b><?php echo e($payment->receivable); ?></b></td>
...
</html><?php /**PATH C:\Users\afraa\OneDrive\Desktop\projects\sakhawat-latest\resources\views/payment/sale-payment-detail.blade.php ENDPATH**/ ?>