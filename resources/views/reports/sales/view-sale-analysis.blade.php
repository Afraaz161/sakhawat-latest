                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sales Analysis</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sparkline7-list">
                                    ...
                                    <div class="sparkline7-graph">
                                        ...
                                        <div class="row" style="text-align: left;">
                                            <form action="{{ route('reports.search-sale-analysis') }}" method="POST">
                                                @csrf
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="brand" id="brand" class="form-control">
                                                            ...
                                                            <option value="University Book Corner">University Book Corner</option>
                                                            <option value="Book Bazar">Book Bazar</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3" class="date-section">
                                                      <div class="form-group">
