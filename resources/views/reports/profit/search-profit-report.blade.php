                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Search Profit Report</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1><span class="res-ds-n">Search Profit List</span></h1>
                                    ...
                                    <div class="sparkline7-graph">
                                        ...
                                        <div class="row" style="text-align: left;">
                                          <form action="{{ route('report.search-profit-report') }}" method="POST">
                                            @csrf
                                            <div class="col-lg-3">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sales as $sale)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="{{ route('report.view-profit-report', ['id'=>$sale->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
