...
<body class="materialdesign">
                                        ...
                                        <div class="main-spark7-hd">
                                            ...
                                            <div class="sparkline7-outline-icon" style="margin-top: -5px;">
                                                <span class="sparkline7-collapse-link">
                                                  <a href="{{ route('reports.purchase.print-all-urdu-search', ['from'=>$from, 'to'=>$to]) }}" class="btn btn-primary btn-printAllPurchaseReportUrdu"><i class="fa fa-print"></i> Urdu</a>
                                                </span>
                                                <span class="sparkline7-collapse-link">
                                                  <a href="{{ route('reports.purchase.print-all-english-search', ['from'=>$from, 'to'=>$to]) }}" class="btn btn-primary btn-printAllPurchaseReportEnglish"><i class="fa fa-print"></i> Eng</a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <form action="{{ route('purchase.search-purchase') }}" method="POST">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                  ...
                                                  <input type="date" class="form-control" value="{{ $from }}" name="from" id="from" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                              <div class="form-group">
                                                <label for="to">End Date</label>
                                                <input type="date" class="form-control" value="{{ $to }}" name="to" id="to" required>
                                              </div>
                                            </div>
                                            <div class="col-lg-1">
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      <a href="{{ route('purchase-list-print-english', ['id' => $purchase->id]) }}" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i> Eng</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
    ...
    <script src="{{asset('pusblic/js/data-table/bootstrap-table-editable.js')}}"></script>
    ...
    <script>
      $(document).ready(function(){
        $('.btn-print').printPage();
        $('.btn-printAllPurchaseReportUrdu').printPage();
        $('.btn-printAllPurchaseReportEnglish').printPage();
      });
    </script>
</body>
