                                                            ...
                                                            @foreach ($sales as $sale)
                                                                <tr>
                                                                  ...
                                                                  @endif
                                                                    ...
                                                                    <td>
                                                                      <a href="{{ route('sale.sale-detail', ['id'=>$sale->id]) }}" class="btn btn-primary" title="View Sale" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                      <a href="{{ route('sale.sale-edit', ['id'=>$sale->id]) }}" class="btn btn-primary" title="Edit Sale" style="color: #fff;"><i class="fa fa-pencil"></i></a>
                                                                      <a href="{{ route('sale.sale-delete', ['id'=>$sale->id]) }}" class="btn btn-primary" title="Delete Sale" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                      <a href="{{ route('sales-list-print-english', ['id' => $sale->id]) }}" class="btn btn-primary btn-print" title="Print Sale" style="color: #fff;"><i class="fa fa-print"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
