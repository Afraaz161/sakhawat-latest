                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sales Return</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1><span class="res-ds-n">Sales Return</span></h1>
                                                            ...
                                                            @foreach ($sales as $sale)
                                                                <tr>
                                                                  ...
                                                                  @endif
                                                                    ...
                                                                    <td>
                                                                      <a href="{{ route('sale.sale-return-detail', ['id'=>$sale->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                      <a href="{{ route('sale.sale-delete', ['id'=>$sale->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                      {{-- <a href="{{ route('sales-list-print-urdu', ['id' => $sale->id]) }}" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i> Urdu</a> --}}
                                                                      <a href="{{ route('sales-return-list-print-english', ['id' => $sale->id]) }}" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i> Eng</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
