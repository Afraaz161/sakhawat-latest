                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    {{-- <button style="margin-top: 5px;" tabindex="4" id="btn-add-in-list" class="btn btn-primary">Add Item</button> --}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="col-lg-12">
                                                ...
                                                <!-- <div class="row" style="margin-top: 20px;">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label for="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                        <input type="number" value="{{$sale->discount}}" class="form-control" name="discount" id="discount">
                                                    </div>
                                                    <div class="col-lg-2">
                                                ...
                                                <div class="row" style="margin-top: 20px;">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" value="{{$sale->remaining}}" name="remaining" id="remaining">
                                                        </div>
                                                    </div>
                                                    {{-- <div class="col-lg-2">
                                                        <label for="receivable">Hold Items</label>
                                                        <button type="submit" class="btn btn-primary btn-hold" style="width: 100%;">Hold ></button>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <label for="receivable">Retrieve Items</label>
                                                        <button type="submit" class="btn btn-primary btn-retrieve" data-toggle="modal" data-target="#holdRetrieveModal" style="width: 100%;">< Retrieve</button>
                                                    </div> --}}
                                                </div>
                                        ...
                                        <a href="{{ route('sale-print-english') }}" class="btn btn-info btn-print" id="btn-print-sale">Print</a>
        ...
        $(document).ready(function(){
            ...
            $(document).scannerDetection({
                ...
                onComplete: function(barcode, qty){ 
                    $.ajax({
                        type: "GET",
                        url: "{{ route('sales.get-sku-product') }}",
                        data: {sku:barcode},
            ...
            $('.btn-print').on('click', function(e){
                ...
                if(radioValue == 'english'){
                    $("#btn-print-sale").attr("href", "{{ route('sale-print-english') }}");
                }
                if(radioValue == 'urdu'){
                    $("#btn-print-sale").attr("href", "{{ route('sale-print-urdu') }}");
                }
            });
            $.get('{{ route("sale.get-vendors") }}', function(data){
                $('#show-vendors-section').empty().append(data);
            });

            $.get('{{ route("sale.get-items") }}', function(data){
            ...
            var sale_id = "{{$sale->id}}";
            $.ajax({
                url: '{{ route("edit-sale.get-items") }}',
                method: "POST",
                data: {_token: '{{ csrf_token() }}', sale_id: sale_id},
            ...
            $('#btn-add-in-list').click(function(e){
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('sales.add-item-to-session') }}",
                    data: {
                            id:id,
                            price:price,
                            qty:qty,
            ...
            $(".btn-hold").on('click', function(e){
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('sales.add-item-to-hold-session') }}",
                    data: {
                            customer:customer,
            ...
            $(".btn-submit").click(function (e) {
                ...
                $.ajax({
                    url: "{{route('sales.new-sale-action')}}",
                    method: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        invoice: invoice,
            ...
            $("#session-items").on('click', '.remove-from-sale', function (e) {
                ...
                if(confirm("Are you sure")) {
                    $.ajax({
                        url: '{{ route("sales.delete-item-to-session") }}',
                        method: "DELETE",
            ...
            $('#session-items').on('change keyup blur', '.cart-quantity' , function (e) {
                ...
                $.ajax({
                    url: '{{ route("edit-sale.edit-item-to-session-quantity") }}',
                    method: "GET",
            ...
            $('.cart-price').on('change keyup blur', function (e) {
                ...
                var price = $(this).val();
                $.ajax({
                    url: '{{ route("sales.edit-item-to-session-price") }}',
                    method: "GET",
            ...
            $("#show-vendors-section").on('change','#customer', function(){
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('sales.get-customer-account-detail') }}",
                    data: {id:id},
                    success: function(data){
                        if(data == ""){
