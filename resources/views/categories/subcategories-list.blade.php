...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sub-Categories</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    <form action="{{ route('subcategories.new-subcategories-action') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="category" class="form-control">
                                                        ...
                                                        @foreach ($categories as $cat)
                                                            <option value="{{ $cat->id }}">{{ $cat->name }} - {{ $cat->u_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                              </div>
                                      ...
                                      <tbody>
                                        ...
                                        @endphp
                                          <tr>
                                              ...
                                              <td>
                                                <a href="{{ route('edit-subcategory',['id'=>$sub->id]) }}" data-id="{{ $sub->id }}" class="btn btn-primary btn-edit-subcategory" style="color: #fff;"><i class="fa fa-edit"></i></a>
                                                {{-- <a href="{{ route('subcategories.delete-subcategory', ['id'=>$sub->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a> --}}
                                              </td>
                                          </tr>
                                        @endforeach
                                      </tbody>
    ...
    <!-- Edit Category Modal -->
    <div class="modal fade" role="dialog" id="edit-subcategory-modal">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" id="show-subcategory-section"> 
