...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Manufactures</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="name" value="{{$manufacture->name}}" class="form-control" id="manufacture">
                                              </div>
                                            </div>
                                            <div class="col-lg-12">
                                              <div class="form-group">
                                                  <label for="u_name">نام</label>
                                                  <input type="text" name="u_name" value="{{$manufacture->u_name}}" class="form-control" id="u_name">
                                              </div>
                                            </div>
                                        </div>
                                  ...
                                  <table id="table1" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                      <thead>
                                          <tr>
                                              ...
                                              <th data-field="u_name">Urdu Name</th>
                                      ...
                                      <tbody>
                                        ...
                                        @endphp
                                          <tr>
                                              ...
                                              <td>{{ $manufacture->u_name }}</td>
                                              <td>
                                                <a href="{{ route('edit-manufacture', ['id' => $manufacture->id]) }}" data-id="{{ $manufacture->id }}" class="btn btn-primary btn-edit-manufacture" style="color: #fff;"><i class="fa fa-edit"></i></a>
                                                {{-- <a href="{{ route('manufactures.delete-manufacture', ['id'=>$manufacture->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a> --}}
                                              </td>
                                          </tr>
                                        @endforeach
                                      </tbody>
    ...
    <div class="modal fade" role="dialog" id="edit-manufacture-modal">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" id="show-manufacture-section"> 
