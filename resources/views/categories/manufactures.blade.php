                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                <div class="income-title">
                                    <div class="main-income-head">
                                        <h2>Create New Manufacture</h2>
                                    </div>
                                </div>
                                <div class="income-dashone-pro">
                                    <form action="{{ route('manufactures.new-manufacture-action') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                              <div class="form-group">
                                                  <label for="manufacture">Name</label>
                                                  <input type="text" name="name" class="form-control" id="manufacture" autofocus>
                                              </div>
                                            </div>
                                            <div class="col-lg-12">
                                              <div class="form-group">
                                                  <label for="u_name">نام</label>
                                                  <input type="text" name="u_name" class="form-control" id="u_name" autofocus>
                                              </div>
                                            </div>
                                        </div>
