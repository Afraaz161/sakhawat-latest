                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category" class="form-control">
                                                        ...
                                                        @foreach ($categories as $cat)
                                                            <option value="{{ $cat->id }}" <?php if($cat->id == $subcategory->category_id){ echo 'selected'; } ?> >{{ $cat->name }} - {{ $cat->u_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                              </div>
                                            ...
                                            {{-- <div class="col-lg-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="u_name" value="{{$subcategory->u_name}}" class="form-control" id="u_name">
                                              </div>
                                            </div> --}}
                                        </div>
