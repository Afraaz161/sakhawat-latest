                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="name" value="{{$category->name}}" class="form-control" id="name" tabindex="1">
                                              </div>
                                            </div>
                                            {{-- <div class="col-lg-12">
                                              <div class="form-group">
                                                  <label for="u_name">نام</label>
                                                  <input type="text" name="u_name" value="{{$category->u_name}}" class="form-control" id="u_name" tabindex="2">
                                              </div>
                                            </div> --}}
                                        </div>
                                      ...
                                      <tbody>
                                        ...
                                        @endphp
                                          <tr>
                                              ...
                                              <td>
                                                <a href="{{route('edit-category', ['id' =>$category->id])}}" data-id="{{ $category->id }}" class="btn btn-primary btn-edit-category" style="color: #fff;"><i class="fa fa-edit"></i></a>
