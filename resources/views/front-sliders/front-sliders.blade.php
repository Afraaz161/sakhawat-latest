                        ...
                        <div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <form action="{{ route('front-sliders-action') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label style="color: #555;">Slider</label>
                                                    <select name="type" class="form-control" required>
                                                        <option value="top">Slider Top</option>
                                                        <option value="bottom">Slider Bottom</option>
                                                    </select>  
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="custom-file-container" data-upload-id="slider">
                                                        <label style="color: #555;">Slider:<a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image"></a></label>
                                                        <label class="custom-file-container__custom-file" >
                                                            <input type="file" name="slider" class="custom-file-container__custom-file__custom-file-input" required>
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    <td>{{ $index }}</td>
                                                                    <td style="text-align: center;"><img src="{{ asset('front/slider/').'/'.$slider->image }}" alt="" style="width:300px;"></td>
                                                                    <td>{{ $slider->type }}</td>
                                                                    <td>
                                                                        <a href="{{ route('front-slider-delete', ['id'=>$slider->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
