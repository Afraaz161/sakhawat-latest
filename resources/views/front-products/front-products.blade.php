                        ...
                        <div class="col-lg-4">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <form action="{{ route('front-products-action') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="english_name">Items</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        ...
                                                        <tbody>
                                                            @foreach ($front_items as $key=>$item)
                                                            @php
                                                                $index = $key+1;
                                                            @endphp
                                                                <tr>
                                                                    <td>{{ $index }}</td>
                                                                    <td style="text-align: center;"><img src="{{ asset('items/').'/'.$item->item['image'] }}" alt="" style="border-radius:50%; width:50px;"></td>
                                                                    <td>{{ $item->item['name'] }}</td>
                                                                    <td>{{ $item->item['price'] }}</td>
                                                                    <td>{{ $item->item['u_name'] }}</td>
                                                                    <td>
                                                                        <a href="{{ route('front-product-delete', ['id'=>$item->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
