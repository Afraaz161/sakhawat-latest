                                                ...
                                                <div class="row" style="margin-top: 20px;">
                                                    ...
                                                    {{-- <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" value="0" name="vendor_previous_due" id="vendor_previous_due" readonly>
                                                        </div>
                                                    </div> --}}
                                                    {{-- <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label for="payable">Payable</label>
                                                            <input type="number" class="form-control" value="0"  name="payable" id="payable" readonly>
                                                        </div>
                                                    </div> --}}
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
        ...
        $(document).ready(function(){
            ...
            $(document).scannerDetection({
                    ...
                    onComplete: function(barcode, qty){ 
                            $.ajax({
                                type: "GET",
                                url: "{{ route('purchase.get-sku-product') }}",
                                data: {sku:barcode},
            ...
            $('.btn-print').on('click', function(e){
                ...
                if(radioValue == 'english'){
                    $("#btn-print-sale").attr("href", "{{ route('purchase-print-english') }}");
                }
                if(radioValue == 'urdu'){
                    $("#btn-print-sale").attr("href", "{{ route('purchase-print-urdu') }}");
                }
            });
            ...
            $("#show-vendors-section").on('change','#customer', function(){
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('purchase.get-customer-account-detail') }}",
                    data: {id:id},
                    success: function(data){
