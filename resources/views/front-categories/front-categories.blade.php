                            ...
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                <div class="income-title">
                                    <div class="main-income-head">
                                        <h2>Add New Front Category</h2>
                                    </div>
                                </div>
                                <div class="income-dashone-pro">
                                    
                                    <form action="{{ route('front-categories-action') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="english_name">Categories</label>
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-field="item name">Category Name</th>
                                                                <th data-field="name urdu">Name Urdu</th>
                                                                <th data-field="actions">Actions</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($front_categories as $key=>$item)
                                                            @php
                                                                $index = $key+1;
                                                            @endphp
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $item->category['u_name'] }}</td>
                                                                    <td>
                                                                        <a href="{{ route('front-category-delete', ['id'=>$item->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
