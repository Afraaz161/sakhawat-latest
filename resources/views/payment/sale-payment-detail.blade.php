                                    ...
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            ...
                                            <div class="sparkline7-outline-icon">
                                                <span><a href="{{route('print-customer-ledger', ['id'=> $id])}}" class="btn-print"><i class="fa fa-print"></i></a></span>
                                                <span><a href="{{route('email-customer-ledger', ['id'=> $id])}}"><i class="fa fa-envelope"></i></a></span>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @endphp
                                                            <tr>
                                                                ...
                                                                <td class="text-success"><b>{{ $payment->receivable }}</b></td>
