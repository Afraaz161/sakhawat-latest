...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sale Account</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1><span class="res-ds-n">Transfered Payment</span></h1>
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-field="payable">Balance</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="" class="btn btn-primary btn-add-other-payment" data-id="{{ $payment->id }}" style="color: #fff;"><i class="fa fa-plus"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
    ...
    <div class="modal fade" id="add-other-payment-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog ms-modal-dialog-width">
          <div class="modal-content ms-modal-content-width">
            <div class="modal-header  ms-modal-header-radius-0">
              <h4 class="modal-title text-white">Add Payment to Other Acount</h4>
              <button type="button" class="close  text-white" data-dismiss="modal" aria-hidden="true">x</button>
            </div>
            <div class="modal-body p-0 text-left" id="show-add-other-payment-modal">
    ...
    <script>
        $(document).ready(function(){
            $('.btn-add-other-payment').click(function(e){
                e.preventDefault();
                var id = $(this).attr('data-id');
                $.ajax({
                  type: "GET",
                  url: "{{ route('get-other-payment-detail') }}",
                  data: {id:id},
                  success: function(data){
                     document.querySelector("#show-add-other-payment-modal").innerHTML = (data);
                     $('#add-other-payment-modal').modal('show');
                  },
                  error: function(data){
                     alert('Error...!');
                  }
