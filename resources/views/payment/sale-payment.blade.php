                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $cust->phone }}</td>
                                                                    <td>
                                                                      <a href="" title="Add Previous Payment" class="btn btn-primary btn-add-previous-payment" data-id="{{ $cust->id }}" style="color: #fff;"><i class="fa fa-history"></i></a>
                                                                      <a href="" title="Add Payment" class="btn btn-primary btn-add-sale-payment" data-id="{{ $cust->id }}" style="color: #fff;"><i class="fa fa-plus"></i></a>
                                                                      <a href="{{route('customer.view-payment-detail', ['id' => $cust->id])}}" title="View Detail" class="btn btn-primary" data-id="{{ $cust->id }}" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#table tbody').on('click', '.btn-add-previous-payment' , function(e){
                ...
                $.ajax({
                  type: "GET",
                  url: "{{ route('add-previous-payment-detail') }}",
                  data: {id:id},
                  success: function(data){
