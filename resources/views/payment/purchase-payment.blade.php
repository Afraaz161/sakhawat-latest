                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $vendor->phone }}</td>
                                                                    <td>
                                                                      <a href="" class="btn btn-primary btn-add-purchase-payment" data-id="{{ $vendor->id }}" style="color: #fff;"><i class="fa fa-plus"></i></a>
                                                                      <a href="{{route('vendor.view-payment-detail', ['id' => $vendor->id])}}" class="btn btn-primary" data-id="{{ $vendor->id }}" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
    ...
    <script>
        $(document).ready(function(){
            $('.btn-add-purchase-payment').click(function(e){
                ...
                $.ajax({
                  type: "GET",
                  url: "{{ route('get-purchase-payment-detail') }}",
                  data: {id:id},
